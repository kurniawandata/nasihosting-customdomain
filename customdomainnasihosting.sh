...
<br>
     ...
     <tr>
                    ...
                    <tr>
                       <td>
                        Captcha </td>
                       <td colspan="2"><img src="https://(domain / ip)/image2.png?$patch">
                       </td>
                        </tr>
                     <tr>
                        <td>Type Captcha : </td>
...
Teknologi captcha gambar, filter input hanya mendukung huruf dan angka dibackend dan berbagai proteksinya lainnya dibuat algoritma dan kode sumbernya oleh Kurniawan. Jika ingin pakai domain sendiri maka sebelumnya harus punya akun subdomain dulu.
            </div>
        </div>
    </div>
<br>
